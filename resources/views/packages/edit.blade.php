    ...
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-4xl">
        ...
        <form action="{{ route('packages.update', ['package' => $package->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex justify-between mt-6">
                ...
                <button type="button" onclick="window.location='{{ route('packages.index')}}'" class="bg-[#f1f1f1] text-[#26535e] font-bold py-3 px-6 rounded-lg hover:bg-[#ddd] focus:outline-none focus:ring-2 focus:ring-[#ddd]">Cancelar</button>
            </div>
        </form>
    </div>
</div>
